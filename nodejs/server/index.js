...
server.get('/config', (req, res, next) => {
    res.render('./views/config', { microsoftAppId: process.env.MicrosoftAppId, baseUrl: process.env.BaseUrl });
});
server.get('/meetingStageTab', (req, res, next) => {
    res.render('./views/meetingStageTab', { microsoftAppId: process.env.MicrosoftAppId, baseUrl: process.env.BaseUrl });
});
